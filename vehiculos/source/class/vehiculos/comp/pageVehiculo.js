qx.Class.define("vehiculos.comp.pageVehiculo",
{
	...
	var functionActualizar = this.functionActualizar = function(){
		...
		rpc.addListener("completed", function(e){
			...
			tableModel.setDataAsMapArray(data.result.gral, true);
			//tbl.setAdditionalStatusBarText(data.result.statusBarText);
		});
